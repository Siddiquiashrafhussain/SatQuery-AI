  ...
  const queryPlaceholder = isCrossModal
    ...
    : isTemporalPair
      ...
      : isUpload
        ...
        : "Provide the live satellite imagery for the selected Area of Interest, along with the current capture date, real-time temperature in Celsius, and a detailed analysis of the current land cover and objects.";
